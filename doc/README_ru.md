...
**Значение ячейки** - для тем типа чисел и времени это их значения. Для переключателя (*chk*) это 2 (*да*), 1 (*лампа*), 0 (*?*), -1 (*нет*); для текста (*xxx*) это по умолчанию 1, но число начальных "+" означает положительную оценку, а число начальных "-" означает отрицательную оценку (например, *"hurray!"* равно 1, *"+++ wow!"* равно 3, а *"-- miau"* равно -2).
