...
**Значение ячейки** - для тем типа чисел и времени это их значения. Для переключателя это 2 (*да*), 1 (*лампа*), 0 (*?*), -1 (*нет*); для текста это всегда 1 плюс число начальных "+" минус число "-" (например, "++ wow!" равно 3). Суммы значений меньше нуля обнуляются (в *EG* нет негатива).
